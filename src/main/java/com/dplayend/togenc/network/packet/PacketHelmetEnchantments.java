...
public class PacketHelmetEnchantments {
    public PacketHelmetEnchantments() {
    }

    public PacketHelmetEnchantments(FriendlyByteBuf buffer) {
    }
                ...
                iterator.forEach(itemStack -> {
                    if (itemStack.getItem() instanceof ArmorItem) {
                        ...
                        if (armorItem.getEquipmentSlot().equals(EquipmentSlot.HEAD)) {
                            ServerNetworking.toggleEnchantmentNetwork(player, itemStack, HandlerConfig.toggle_helmet.get());
                        }
                    }
                });
            }
