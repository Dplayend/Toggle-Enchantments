...
public class PacketBootsEnchantments {
    public PacketBootsEnchantments() {
    }

    public PacketBootsEnchantments(FriendlyByteBuf buffer) {
    }
                ...
                iterator.forEach(itemStack -> {
                    if (itemStack.getItem() instanceof ArmorItem) {
                        ...
                        if (armorItem.getEquipmentSlot().equals(EquipmentSlot.FEET)) {
                            ServerNetworking.toggleEnchantmentNetwork(player, itemStack, HandlerConfig.toggle_boots.get());
                        }
                    }
                });
            }
