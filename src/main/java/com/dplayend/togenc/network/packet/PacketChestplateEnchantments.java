...
public class PacketChestplateEnchantments {
    public PacketChestplateEnchantments() {
    }

    public PacketChestplateEnchantments(FriendlyByteBuf buffer) {
    }
                ...
                iterator.forEach(itemStack -> {
                    if (itemStack.getItem() instanceof ArmorItem) {
                        ...
                        if (armorItem.getEquipmentSlot().equals(EquipmentSlot.CHEST)) {
                            ServerNetworking.toggleEnchantmentNetwork(player, itemStack, HandlerConfig.toggle_chestplate.get());
                        }
                    }
                });
            }
